				...
				steps {
					...
					checkout(
						[
							...
							userRemoteConfigs: [[url: 'https://github.com/Abhid2000/project-002.git']]						
						]
						)
	...
	post {
		success {
			...
			if (env.BRANCH_NAME == 'master'){
				...
				sh('git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/Abhid2000/project-002.git HEAD:master')
					}
				} else if (env.BRANCH_NAME == 'dev'){
